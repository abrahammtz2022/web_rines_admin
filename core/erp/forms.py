...
from core.erp.models import Category, Product, Client, Sale, Sucursal
...
class SaleForm(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['cli'].widget.attrs['class'] = 'custom-select select2'
...
class ProductssForm(forms.Form):
    class Meta:
        model = Product
        fields = '__all__'
    # def save(self, commit=True):
