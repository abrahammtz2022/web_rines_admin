        ...
        columnDefs: [
            {
                ...
                render: function (data, type, row) {
                    ...
                    return '<span class="badge badge-secondary">'+'0'.repeat(5 - String(data).length) + data+'</span>';
                }
            },
            {
                targets: [-2, -3, -4],
            ...
            },
            {
                ...
                render: function (data, type, row) {
                    ...
                    buttons += '<a href="/erp/sale/invoice/pdf/' + row.id + '/" target="_blank" class="btn btn-info  btn-xs btn-flat" style="color: white"><i class="fas fa-file-pdf"></i></a> ';
                    buttons += '<a href="/erp/sale/mirar/' + row.id + '/" target="_blank" class="btn btn-warning btn-xs btn-flat"><i class="fas fa-print"></i></a> ';
                    return buttons;
                }
            },
        ],
